...
std::string _dir("/Users/zhongsifen/Work/Mien58_model/model/");

int main_x(int argc, char** argv) try
{
    if (argc != 2)
    {
    ...
    shape_predictor sp;
    deserialize(_dir + "shape_predictor_5_face_landmarks.dat") >> sp;
    // And finally we load the DNN responsible for face recognition.
    anet_type net;
    deserialize(_dir + "dlib_face_recognition_resnet_model_v1.dat") >> net;
