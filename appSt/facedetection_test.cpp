...
std::string _D("/Users/zhongsifen/Github/SeetaFaceEngine/FaceDetection/");
int argc = 3;
char* argv[] = {
	(char*)"facedetection_test",
	(char*)"data/0_1_1.jpg",
	(char*)"model/seeta_fd_frontal_v1.0.bin",
};
...
int main(int argc_, char** argv_) {
  ...
  seeta::FaceDetection detector(_D + argv[2]);
  ...
  cv::Mat img = cv::imread(_D + img_path, cv::IMREAD_UNCHANGED);
  cv::Mat img_gray;
